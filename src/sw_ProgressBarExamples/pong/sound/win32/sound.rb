...
module Win32Sound
  ...
  class Sound
    ...
    # the type of the device and a zero-based ID number. Possible return set_values
    ...
    #   system default sound unless the NODEFAULT set_value is also specified.
    ...
    # case it is assumed you are setting both channels to the same set_value.
    #
